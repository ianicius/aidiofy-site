    ...
    <LegalLayout title="Privacy Policy" lastUpdated="27 November 2025">
      <section className="space-y-3">
        ...
        <p>
          ...
          <a className="text-text-main underline decoration-primary/60 hover:decoration-primary transition-colors ml-1" href="mailto:rj@aidiofy.com">
            rj@aidiofy.com
          </a>
          .
        </p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">2. Scope</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">3. Categories of data we collect</h2>
        <p>Depending on how you use the Service, we may process:</p>
        <ul className="list-disc list-inside space-y-1">
          <li>
            <strong className="text-text-main">Account data:</strong> e-mail address; authentication data (password hash if you register
            with e-mail/password, or tokens for social login such as Google).
          </li>
          <li>
            <strong className="text-text-main">Usage data:</strong> how you use the Service (features, frequency, timestamps), technical logs and events (e.g. request IDs, error logs).
          </li>
          <li>
            <strong className="text-text-main">Device and connection data:</strong> IP address (with possible IP anonymization), browser type and version, operating system, approximate location derived from IP (city/country level).
          </li>
          <li>
            <strong className="text-text-main">Content processed through the Service:</strong> text you submit (e.g. parts of manuals, descriptions, scenarios) and images you upload. Content is processed only to generate audio and is not stored long term; it may appear temporarily in memory, caches, or short-term logs necessary for delivering the Service securely.
          </li>
          <li>
            <strong className="text-text-main">Communication data:</strong> messages you send us via e-mail or forms; your preferences and consents (e.g. newsletter or optional content use).
          </li>
          <li>
            <strong className="text-text-main">Newsletter data (optional):</strong> e-mail address and subscription metadata if you opt in when the feature is offered.
          </li>
        </ul>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">4. Purposes and legal bases</h2>
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong className="text-text-main">Providing and operating the Service:</strong> account creation, authentication, processing text/images to generate audio; legal basis: performance of a contract (Art. 6(1)(b) GDPR).
          </li>
          <li>
            <strong className="text-text-main">Customer support and communication:</strong> responding to requests, bug reports, feedback; legal basis: contract (Art. 6(1)(b)) and/or legitimate interest (Art. 6(1)(f)).
          </li>
          <li>
            <strong className="text-text-main">Analytics and service improvement:</strong> understanding usage, improving performance, detecting abuse; legal basis: legitimate interest (Art. 6(1)(f)).
          </li>
          <li>
            <strong className="text-text-main">Optional research and improvement using User Content/Generated Output:</strong> only if you explicitly opt in; legal basis: consent (Art. 6(1)(a)). You can withdraw at any time.
          </li>
          <li>
            <strong className="text-text-main">Newsletter and marketing (optional):</strong> only with your consent (Art. 6(1)(a)); you can unsubscribe at any time.
          </li>
          <li>
            <strong className="text-text-main">Security and fraud prevention:</strong> monitoring for suspicious activity and securing systems; legal basis: legitimate interest (Art. 6(1)(f)).
          </li>
          <li>
            <strong className="text-text-main">Legal obligations:</strong> tax, accounting, responding to lawful requests; legal basis: compliance with legal obligations (Art. 6(1)(c)).
          </li>
        </ul>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">5. Cookies and analytics</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">6. Recipients and processors</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">7. International transfers</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">8. Data retention</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">9. Data security</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">10. Your rights under GDPR</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">11. Children&apos;s privacy</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">12. Changes to this Policy</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-xl md:text-2xl font-semibold text-text-main">13. Contact</h2>
        <p>
